...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifact, model_pusher_config: ModelPusherConfig):
        ...
        self.sss_estimator = S3Estimator(bucket_name=model_pusher_config.bucket_name,
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            ...
            self.sss_estimator.save_model(from_file=self.model_evaluation_artifact.trained_model_path)
